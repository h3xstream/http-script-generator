...
public class LanguageOption {
    ...
    public static final LanguageOption PYTHON_SULLEY = new LanguageOption("Python (Sulley)", "sulley", BASE_TPL_CLASSPATH + "python_sulley.tpl", SyntaxConstants.SYNTAX_STYLE_PYTHON, "py");
