...
public class LanguageOption {
    ...
    public static final LanguageOption PHP_CURL = new LanguageOption("PHP (cURL)", BASE_TPL_CLASSPATH+"php.tpl", SyntaxConstants.SYNTAX_STYLE_PERL); //STYLE_PHP doesn't appears to work at the moment
